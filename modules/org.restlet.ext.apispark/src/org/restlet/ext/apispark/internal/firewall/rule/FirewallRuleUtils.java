 ...
 */
public class FirewallRuleUtils {
     ...
     */
    public static FirewallCounterRule createHostDomainConcurrencyCounterRule(
                                                                         int limit) {
     ...
     * @return The associated rule.
     */
    public static FirewallCounterRule createHostDomainPeriodicCounterRule(
     ...
     * @return The associated rule.
     */
    public static FirewallCounterRule createIpAddressesBlackListRule(List<String> blackList) {
        FirewallCounterRule rule = new ConcurrentFirewallCounterRule(
     ...
     * @return The associated rule.
     */
    public static FirewallCounterRule createIpAddressesConcurrencyCounterRule(
            int limit) {
        FirewallCounterRule rule = new ConcurrentFirewallCounterRule(
                new IpAddressCountingPolicy());
        rule.addHandler(new BlockingHandler(new UniqueLimitPolicy(limit)));
     ...
     * @return The associated rule.
     */
    public static FirewallCounterRule createIpAddressesPeriodicCounterRule(
            int period, int limit) {
        FirewallCounterRule rule = new PeriodicFirewallCounterRule(period,
                new IpAddressCountingPolicy());
        rule.addHandler(new BlockingHandler(new UniqueLimitPolicy(limit)));
     ...
     * @return The associated rule.
     */
    public static FirewallCounterRule createIpAddressesWhiteListRule(List<String> whiteList) {
        FirewallCounterRule rule = new ConcurrentFirewallCounterRule(
                new IpAddressCountingPolicy());
        Map<String, Integer> map = new HashMap<String, Integer>();
     ...
     * @return The associated rule.
     */
    public static FirewallCounterRule createRolesConcurrencyCounterRule(
            Map<String, Integer> limitsPerRole) {
        return createRolesConcurrencyCounterRule(limitsPerRole, 0);
    }
     ...
     * @return The associated rule.
     */
    public static FirewallCounterRule createRolesPeriodicCounterRule(
            int period, Map<String, Integer> limitsPerRole) {
        return createRolesPeriodicCounterRule(period, limitsPerRole, 0);
    }
