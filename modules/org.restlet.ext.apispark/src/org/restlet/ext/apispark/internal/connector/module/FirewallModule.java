...
public class FirewallModule extends Filter {
    ...
    public FirewallModule(ConnectorAgentConfig connectorAgentConfig, ModulesSettings modulesSettings, Context context) {
        ...
        FirewallSettingsResource firewallSettingsClientResource = AgentUtils.getConfiguredClientResource(
                connectorAgentConfig, modulesSettings, FirewallSettingsResource.class, SETTINGS_PATH);

        FirewallSettings firewallSettings;
        try {
            firewallSettings = firewallSettingsClientResource.getSettings();
        } catch (Exception e) {
            throw new ConnectorConfigurationException("Could not get firewall module configuration from APISpark connector service", e);
        }
